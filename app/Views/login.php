      ...
      <div class="row">
        ...
        <div class="col-xl-5 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo text-start" href="index.html"><h1>Shop Manage</h1></a></div>
              <div class="login-main"> 
                <form class="theme-form" method="post" action="{{cdn}}auth/login">
                  ...
                  <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="{{u}}auth/new_account">Create Account</a></p>
                </form>
              </div>
            </div>
          </div>
